...
#define SLN_PI 3.14159265358979323846f
#define SLN_PI_2 2.0f * SLN_PI
#define SLN_HALF_PI 0.5f * SLN_PI
#define SLN_QUARTER_PI 0.25f * SLN_PI
#define SLN_ONE_OVER_PI 1.0f / SLN_PI
#define SLN_ONE_OVER_TWO_PI 1.0f / SLN_PI_2
#define SLN_SQRT_TWO 1.41421356237309504880f
#define SLN_SQRT_THREE 1.73205080756887729352f
#define SLN_SQRT_ONE_OVER_TWO 0.70710678118654752440f
#define SLN_SQRT_ONE_OVER_THREE 0.57735026918962576450f
#define SLN_DEG2RAD_MULTIPLIER SLN_PI / 180.0f
#define SLN_RAD2DEG_MULTIPLIER 180.0f / SLN_PI

// The multiplier to convert seconds to milliseconds.
#define SLN_SEC_TO_MS_MULTIPLIER 1000.0f

// The multiplier to convert milliseconds to seconds.
#define SLN_MS_TO_SEC_MULTIPLIER 0.001f

// A huge number that should be larger than any valid number used.
#define SLN_INFINITY 1e30f

// Smallest positive number where 1.0 + FLOAT_EPSILON != 0
#define SLN_FLOAT_EPSILON 1.192092896e-07f

// ------------------------------------------
// General math functions
// ------------------------------------------
SLN_API f32 sln_sin(f32 x);
SLN_API f32 sln_cos(f32 x);
SLN_API f32 sln_tan(f32 x);
SLN_API f32 sln_acos(f32 x);
SLN_API f32 sln_sqrt(f32 x);
SLN_API f32 sln_abs(f32 x);
...
SLN_API i32 sln_random();
SLN_API i32 sln_random_in_range(i32 min, i32 max);

SLN_API f32 fsln_random();
SLN_API f32 fsln_random_in_range(f32 min, f32 max);
