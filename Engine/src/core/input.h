...
// keyboard input
SLN_API b8 input_is_key_down(keys key);
SLN_API b8 input_is_key_up(keys key);
SLN_API b8 input_was_key_down(keys key);
SLN_API b8 input_was_key_up(keys key);

void input_process_key(keys key, b8 pressed);

// mouse input
SLN_API b8 input_is_button_down(buttons button);
