...
SLN_API void* _darray_create(u64 length, u64 stride);
SLN_API void _darray_destroy(void* array);

SLN_API u64 _darray_field_get(void* array, u64 field);
SLN_API void _darray_field_set(void* array, u64 field, u64 value);

SLN_API void* _darray_resize(void* array);

SLN_API void* _darray_push(void* array, const void* value_ptr);
SLN_API void _darray_pop(void* array, void* dest);

SLN_API void* _darray_pop_at(void* array, u64 index, void* dest);
SLN_API void* _darray_insert_at(void* array, u64 index, void* value_ptr);
