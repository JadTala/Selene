    ...
    if (!fence->is_signaled) {
        ...
        switch (result) {
            case VK_SUCCESS:
                ...
                return TRUE;
            case VK_TIMEOUT:
                SLN_WARN("vk_fence_wait - Timed out");
                break;
            case VK_ERROR_DEVICE_LOST:
                SLN_ERROR("vk_fence_wait - VK_ERROR_DEVICE_LOST.");
                break;
            case VK_ERROR_OUT_OF_HOST_MEMORY:
                SLN_ERROR("vk_fence_wait - VK_ERROR_OUT_OF_HOST_MEMORY.");
                break;
            case VK_ERROR_OUT_OF_DEVICE_MEMORY:
                SLN_ERROR("vk_fence_wait - VK_ERROR_OUT_OF_DEVICE_MEMORY.");
                break;
            default:
                SLN_ERROR("vk_fence_wait - An unknown error has occurred.");
                break;
        }
    } else {
